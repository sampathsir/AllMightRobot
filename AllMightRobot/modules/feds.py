...
from AllMightRobot import OWNER_ID, BOT_ID, OPERATORS, decorator, bot
...
<code>(file)</code>: required file, if file isn't provided you will be entered in file state, this means AllMight will wait file message from you. Type /cancel to leave from it.
